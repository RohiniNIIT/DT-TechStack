...
<nav class="navbar navbar-inverse">
  ...
  <li>  <a href="home1.jsp"><span class="glyphicon welcome">
	...
	<li> <a href="Registration.jsp"><span class="glyphicon glyphicon-user">
	 ...
	 <li> <a href="home1.jsp"><span class="glyphicon glyphicon-user">
...
<h1>DataBase Login Success</h1>
 <ul class="nav navbar-nav navbar-right">
     
  
 <!--  <li>  <a href="home1.html"><span class="glyphicon welcome">
	  </span> &nbsp Welcome!</a></li>
	  
 	<li><a href="store.html"><span class="glyphicon glyphicon-log-in">
	  </span> &nbsp SignIn</a></li>
	  
	<li> <a href="Registration.html"><span class="glyphicon glyphicon-user">
