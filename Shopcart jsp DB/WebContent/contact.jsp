...
<div id="contact" class="container">
  ...
  <p class="text-center"><em>Buy Everything Easy</em></p>

  <div class="row">
    <div class="col-md-4">
      <p>Contact Here.</p>
      <p><span class="glyphicon glyphicon-map-marker"></span>Hyderabd,India</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +91 2222222222</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: Shoppingcart@shop.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
