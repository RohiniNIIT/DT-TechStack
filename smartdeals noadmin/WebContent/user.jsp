...
<body>
	<form action="UserController.do" method="post">
		<fieldset>
			<div>
				<label for="UserId">User ID</label> <input type="text" class="form-control"
					name="UserId" value="<c:out value="${User.UserId}" />"
					readonly="readonly" placeholder="User ID" />
			</div>
			<div>
				<label for="UserName">User Name</label> <input type="text" class="form-control"
					name="UserName" value="<c:out value="${User.UserName}" />"
					 placeholder="User Name" />
			</div>
			<div>
				<label for="UserPassword">User Password</label> <input type="text" class="form-control"
					name="UserPassword" value="<c:out value="${User.UserPassword}" />"
  ...
  <!--  
<div class="container">
  <h2><strong>Users<strong></h2><br><br>
