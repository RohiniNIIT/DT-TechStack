...
<h2>Suppliers</h2>
	<form action="SupplierController.do" method="post">
		<fieldset>
			...
			<div>
				<label for="supplierName">Supplier Name</label> <input type="text" class="form-control"
					name="supplierName" value="<c:out value="${supplier.supplierName}" />"
					 placeholder="Supplier Name" />
			</div>
			
			<div>
				<label for="supplierDescription">Supplier Description</label> <input type="text" class="form-control"
					name="supplierDescription" value="<c:out value="${supplier.supplierDescription}" />"
					 placeholder="Supplier Description" />
			</div>
			
			<div>
				<label for="supplierAddress">Supplier Address</label> <input type="text" class="form-control"
