...
<input type="radio" name="gender" value="male" checked> Male
  <input type="radio" name="gender" value="female"> Female<value="<c:out value="${register.gender}" />/> 
	...
	<div>
				<label for="requestAccess">Request Access</label>


<input type="radio"name="requestAccess"  value="Admin" checked> Admin
  <input type="radio"name="requestAccess"  value="User"> User<value="<c:out value="${register.requestAccess}" />/> 
					
					 <br>
	    </form>
   <br><br>
   
	<a href="AdminCongrats.jsp">
