  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="supplierindex.jsp">Suppliers</a></li>
    ...
    <li><a href="#"><span class="glyphicon welcome">
	   ...
	   <li><a href="Manage Profiles.jsp"><span class="glyphicon glyphicon-log-in"style="padding-right: 4px">
	  </span>Manage Profiles</a></li>
	   <li><a href="setpassword.jsp"><span class="glyphicon glyphicon-log-in"style="padding-right: 4px">
	  </span>Set Password</a></li>
