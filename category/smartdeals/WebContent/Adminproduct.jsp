...
<h2>Products</h2>
	<form action="ProductController.do" method="post">
		<fieldset>
			...
			<div>
				<label for="productDescription">Product Description</label> <input type="text" class="form-control"
					name="productDescription" value="<c:out value="${product.productDescription}" />"
					 placeholder="Product Description" />
			</div>
			<div>
				<label for="catagoryId">Catagory ID</label> <input type="text" class="form-control"
					name="catagoryId" value="<c:out value="${catagory.catagoryId}" />"
					 placeholder="Catagory ID" />
			</div>
			<div>
				<label for="catagoryName">Catagory Name</label> <input type="text" class="form-control"
					name="catagoryName" value="<c:out value="${catagory.catagoryName}" />"
